            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title">Dodawanie nowego rodzaju strony</h4>

                        <form class="content-type-form" method="POST"
                              action="{{route('SitesModule::site-types.store')}}">
                            @csrf
                            ...
                            <div class="form-group @error('blade') has-danger @enderror">
                                ...
                                <input type="text" class="form-control" name="blade" placeholder="Wpisz szablon" value="{{old('blade')}}">
